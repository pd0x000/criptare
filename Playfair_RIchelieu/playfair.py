# -*- coding: utf-8 -*-
"""
Created on Tue Dec 28 17:18:33 2021
...
def main():
    ...
    key = input("Introduceti key-ul: ").replace(" ","").upper()
    plainText =input("Textul clar: ").replace(" ","").upper()

    convertedPlainText = convertPlainTextToDiagraphs(plainText)
    
    print('Textul clar introdus : '+convertedPlainText)
